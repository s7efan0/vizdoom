...
class VizDoomEnv(Env):
    def __init__(self, render=False):
        super().__init__()
        self.game = DoomGame()
        self.game.load_config("../ViZDoom-master/scenarios/my_way_home.cfg")
    ...
    def step(self, action):
        actions = np.identity(5, dtype=np.uint8)
...
def train():
    ...
    # print((grayscale(env.game.get_state().screen_buffer)).shape)
