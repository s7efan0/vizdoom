...
class VizDoomEnv(Env):
    def __init__(self, render=False):
        super().__init__()
        self.game = DoomGame()
        self.game.load_config("../ViZDoom-master/scenarios/predict_position.cfg")
...
def makeGif():
    ...
    imageio.mimsave('predictPosition.gif', [np.array(img) for i, img in enumerate(images) if i % 2 == 0], fps=15)
